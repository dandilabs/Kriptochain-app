...
@section('title', 'Bitcoin News')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0">
            <i class="fab fa-bitcoin text-gradient-warning"></i>
            <span class="text-gradient-btc">Bitcoin News</span>
        </h1>
        <div class="btn-group">
            <button class="btn btn-sm btn-outline-warning" id="refresh-news">
                    ...
                    <div class="card h-100 border-0 shadow-sm hover-shadow-lg transition-all">
                        ...
                        @else
                            <div class="card-img-top bg-gradient-dark d-flex align-items-center justify-content-center"
                                style="height: 180px;">
                                <i class="fab fa-bitcoin fa-3x text-warning opacity-50"></i>
                            </div>
                        @endif
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title clamp-2-lines" style="min-height: 48px;">
                                <a href="{{ $item['link'] ?? '#' }}" target="_blank"
                                    class="text-dark text-decoration-none hover-text-warning">
                                    {{ $item['title'] ?? 'No Title' }}
                                </a>
                            </h5>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body text-center py-5">
                        <i class="fab fa-bitcoin fa-4x text-muted mb-4"></i>
                        <h4 class="text-muted">No Bitcoin news found</h4>
                        <p class="text-muted">Try refreshing the page or check back later</p>
                        <button class="btn btn-warning mt-3" id="refresh-empty">
...
@section('css')
    <style>
        .text-gradient-btc {
            background: linear-gradient(135deg, #ffe066, #ffb300 70%);
        ...
        .hover-shadow-lg:hover {
            box-shadow: 0 10px 25px rgba(255, 193, 7, 0.13);
        ...
        .bg-gradient-dark {
            background: linear-gradient(135deg, #232526, #ffd700);
        }
